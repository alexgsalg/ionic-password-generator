...
export class HomePage implements OnInit {
    ...
    onOptionsChange(): void {
        ...
        // Score calculation
        if (this.passLength as number > 8 || this.checkOptions.lowercase || this.checkOptions.uppercase) score += 1;
    ...
    getCharacters(): string[] {
        let characters: any[] = [];
        if (this.checkOptions.lowercase) characters = [...characters, ...Characters.lowercase];
        if (this.checkOptions.uppercase) characters = [...characters, ...Characters.uppercase];
        if (this.checkOptions.numbers) characters = [...characters, ...Characters.numbers];
        if (this.checkOptions.specials) characters = [...characters, ...Characters.specials];
        return characters
    }
